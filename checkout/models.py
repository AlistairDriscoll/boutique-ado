...
class Order(models.Model):
    ...
    # SET_NULL will set the user_profile the null but keep the rest of the order so it stays on record
    # null and blank = true so that the user doesn't need an account to create orders
    ...
    # no 'models.' before this field because django.db.models has no attribute 'CountryField'
